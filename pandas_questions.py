...
def merge_regions_and_departments(regions, departments):
    ...
    merged = pd.merge(regs, deps, on='code_reg', how='left')
...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    # Keeping only the postal code from 1 to 95 and 2A, 2B
    # to not consider french living abroad or DOM-TOM-COM departments
    refs = referendum[referendum["Department code"].isin(wanted_zones)]
    merged = pd.merge(refs, regions_and_departments, how='left',
