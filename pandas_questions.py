...
def merge_regions_and_departments(regions, departments):
    ...
    regdep = pd.merge(regions[["code_reg", "name_reg"]],
...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    refarea = pd.merge(referendum, regions_and_departments,
                       left_on="Department code",
                       right_on="code_dep", how="left")
    return refarea.dropna()
...
def compute_referendum_result_by_regions(referendum_and_areas):
    ...
    """
    referendum_and_areas.drop(columns=["Department code", "Department name",
                              "Town code", "Town name", "name_dep"],
                              inplace=True)
    referendumareas = referendum_and_areas.groupby(["code_reg", "name_reg"],
                                                   as_index=False).sum()
    referendum_and_areas = referendumareas.set_index("code_reg")
