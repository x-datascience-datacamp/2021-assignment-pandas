...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    """
    regions_gpd = gpd.read_file("./data/regions.geojson").set_index("code") \
        .join(referendum_result_by_regions, how="inner") \
        .dropna() \
        .assign(all=lambda x: x["Choice A"]+x["Choice B"],
                ratio=lambda x: x["Choice A"]/x["all"])

    regions_gpd.plot(column="ratio")
