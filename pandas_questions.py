...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    list_to_drop = ['975', '977', '978', '984', '986', '987', '988', '989', '971', '972', '973', '974', '976', 'ZA', 'ZB', 'ZC', 'ZD', 'ZM', 'ZN', 'ZP', 'ZS', 'ZW', 'ZX', 'ZZ']
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    referendum_results = gpd.GeoDataFrame(pd.merge(referendum_result_by_regions, geo_data, how='left', on='code_reg'))
